...
import kebab_simulator.model.meal.ingredients.IngredientOnion;
...
public class EntityOnion extends EntityFood implements IEntityCuttable {
    ...
    public EntityOnion(double x, double y) {
        ...
        this.setRenderer(new AnimationRenderer(
                "/graphic/item/food/onion.png", 2, 2, 32, 32,
                OnionAnimationState.DEFAULT
        ));
    }
    ...
    public void update(double dt) {
        ...
        if (this.cuttingState == EntityCuttingState.CUTTING) {
            ...
            this.renderer.switchState(OnionAnimationState.CUT_SMALL);
        }
    }
    ...
    public double getCuttingDuration() {
        return IngredientOnion.getInstance().getTargetState().getCutDuration();
    }
