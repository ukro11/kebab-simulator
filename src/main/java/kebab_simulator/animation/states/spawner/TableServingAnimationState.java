...
public enum TableServingAnimationState implements IAnimationState {
    ...
    TableServingAnimationState(int rowIndex, Range<Integer> columnRange, int frames, double duration, boolean loop, boolean reverse, int frameWidth, int frameHeight) {
