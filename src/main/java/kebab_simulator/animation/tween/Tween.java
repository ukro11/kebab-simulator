package kebab_simulator.animation.tween;

import kebab_simulator.animation.Easings;
import kebab_simulator.animation.tween.value.Tween2d;
import kebab_simulator.animation.tween.value.Tween2i;
import kebab_simulator.animation.tween.value.TweenValue;
